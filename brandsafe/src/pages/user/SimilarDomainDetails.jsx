                        ...
                        <tbody className=''>
                            {domains?.similarDomain?.map((domain, index) =>
                                <tr key={index} className='divide-x-[1px] divide-gray-300 even:bg-gray-100'>
                                    <td className='px-4 py-2 text-blue-600 hover:underline cursor-pointer'><a target="_blank" rel="noopener noreferrer" className='flex gap-1 items-center' href={domain.domainURL} >{domain.domainURL}<KeyboardDoubleArrowRightIcon fontSize='34px' /></a></td>
